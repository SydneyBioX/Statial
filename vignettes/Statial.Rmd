...
tmp = colTest(kontextMat, condition = kerenSurv, type = "ttest")
...
```  
Repeating the Kaplan-Meier curve visualisation for the state matrix. Here, localisation would refer to increased localisation between Keratin6 expressing keratin/tumour cells and CD4 cells, i.e. localisation means keratin/tumour cells tend to increase Keratin6 expression nearby CD4 cells, whilst dispersion would mean keratin/tumour cells do not tend to express Keratin6 near CD4 cell populations.
