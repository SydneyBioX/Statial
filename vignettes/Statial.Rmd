...
Similar survival analysis can be done using the state changes results. 
...
Here, we use the `performancePlot` function to assess the C-index from each repeat of the 3-fold cross-validation. We see that cell type proportions appears to capture the least amount of information predictive of patient survival. Features generated using Kontextual and Marker Means appear to be the most useful for predicting patient survival.
