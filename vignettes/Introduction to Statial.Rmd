...
and gene expression occurs between B cells and CD8+ T cells for the CD8 gene.
The CD8 gene codes a ligand present on CD8+ T cells, and should not be expressed 
on B cells. 
...
This brings us to a key problem of segmentation - contamination.
```{r}
visualiseImageRelationship(
  data = SCE,
  Rs = c(200),
